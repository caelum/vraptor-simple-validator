...
import static br.com.caelum.vraptor.simplevalidator.ValidationStrategies.DEFAULT_AND_KEY;
...
public class AndValidationStrategyTest extends SimpleValidatorTestBase{
	...
	public void should_verify_multiple_validations_with_one_key() {
		...
		verify(validationStrategyHelper).addError(DEFAULT_AND_KEY, lessThan2, biggerThan0);
	}
	
	@Test
	public void should_not_add_errors_if_everyting_goes_fine() {
		validator.validate(1l, and(lessThan2, biggerThan0));
		verify(validationStrategyHelper, never()).addError(DEFAULT_AND_KEY, lessThan2, biggerThan0);
	}
	...
	public void should_not_add_two_errors_to_and_rule() {
		...
		verify(validationStrategyHelper, times(1)).addError(DEFAULT_AND_KEY, lessThan0, biggerThan2);
	}
